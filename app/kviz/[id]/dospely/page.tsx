...
export default function DospelyKvizPage({ params }: { params: { id: string } }) {
  ...
  const questions = quizItem.adult
    ...
    <div className="min-h-screen flex flex-col bg-[#f8f5e4]">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-center text-gray-600">Dospělá verze kvízu</p>
        </div>
        ...
        {questions.length === 0 ? (
          <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto text-center">
            ...
            <p>Pro toto místo zatím nejsou k dispozici žádné otázky v dospělé verzi.</p>
